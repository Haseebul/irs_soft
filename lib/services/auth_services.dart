...
import 'package:ir_soft/screens/home_screen.dart';
import 'package:ir_soft/utils/constants.dart';
import 'package:ir_soft/utils/utils.dart';
...
class AuthService {
  ...
  void signInUser({
    ...
    try {
      ...
      http.Response res = await http.post(
        Uri.parse('${Constants.uri}/api/public_Things'),
        body: jsonEncode({
          'email': email,
          'password': password,
        }),
